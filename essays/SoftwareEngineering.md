...
## Conclusion
The importance of software engineering is significant and will only continue to grow in the future. Just because a person doesn't believe they can build a product like google maps or a learning management site doesn't mean they can't build a simple product that can make their life more convenient. Learning the basics of software engineering is very important even if you are only building a project that you will only ever see, because the usage of software that people use everyday is already significant and will only continue to grow.
